Fix the Android project at /tmp/avanti-pet-cart so the failing build-fix-1 step passes.
...
Recent failure log:
```text
/home/codex-agent/codex-app-agent/build-debug.sh: line 12: ./gradlew: Permission denied
